...
public class MedicoController {
	...
	@PostMapping
	public ResponseEntity<Object> registar(@Valid @RequestBody Medico obj) { //@RequestBody lee el json y lo representa en un objeto java
		Medico paciente = service.registrar(obj);
